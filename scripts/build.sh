...
for executable in manager manager-runtime/bin/bun manager-runtime/bin/cf manager-runtime/bin/collie sandbox/runtime/bin/bun sandbox/runtime/bin/herdr sandbox/runtime/bin/collie sandbox/runtime/bin/opencode sandbox/runtime/bin/sandbox-bootstrap sandbox/runtime/start.sh sandbox/runtime/start-bash.sh; do
